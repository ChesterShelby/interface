...
# В четвертом обработчике мы использовали анонимную функцию. В ней мы сначала создаем
# объект класса MyClass, передав ему в качестве параметра число 5, после чего сразу же вызываем его как функцию,
# указав после конструктора пустые скобки.
# button.clicked.connect(lambda: MyClass(5)())
