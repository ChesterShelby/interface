"""
В данном случае наша программа ничего не делает, кроме как выводит текст при нажатии на кнопки.
Далее для наших расчетов, нам, необходимо извлекать текст из текстовых полей,
производить расчет и подставлять результат в нашу надпись.
"""
...
class Window(QtWidgets.QWidget):
    ...
    """Начнем с получения данных с текстового поля"""
    def get_area(self):
